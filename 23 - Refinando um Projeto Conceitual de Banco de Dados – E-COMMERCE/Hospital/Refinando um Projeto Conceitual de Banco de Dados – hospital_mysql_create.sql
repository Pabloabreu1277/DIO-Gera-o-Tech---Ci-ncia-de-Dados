...
ALTER TABLE `Consulta` ADD CONSTRAINT `Consulta_fk1` FOREIGN KEY (`IdExame`) REFERENCES `Exame`(`IdExame`);

ALTER TABLE `Consulta` ADD CONSTRAINT `Consulta_fk2` FOREIGN KEY (`IdPaciente`) REFERENCES `Paciente`(`IdPaciente`);
